...
Maybe we should follow the **Copenhagen Interpretation**, that simply says don't think about it. Are you still thinking about it? I told you to stop! By merely thinking about it, you are collapsing the wave function. It's like starting hot water in the sink while people are showering!
...
It contains all the above, plus Nick Offerman, Jesus, Russian spies, and the truth about the Kennedy assassination (it was Oswald).
...
In one of the later episodes, the protagonist mentions that he gave the name Devs to the quantum computer that is the MacGuffin of the whole story as a sort of inside joke, as the letter v in the name has to be pronounced as if it was in Latin.

And I'm like hmm, so is it Defives? What does it even mean?!
...
I'll add some references as if this was some research paper and shit...

### Quantum mechanics

If you want to know more about quantum mechanics, [this](https://bookshop.org/search?keywords=Something+Deeply+Hidden+Sean+Carroll) is a great entry-level read.
...
Hello this is Gianluca from the future. Turns out that quantum erasure experiment is kinda bullshit, as wonderfully put by Sean Carroll in his [blog](https://www.preposterousuniverse.com/blog/2019/09/21/the-notorious-delayed-choice-quantum-eraser/). This means that Reality is not broken. I repeat: Reality is not broken.
