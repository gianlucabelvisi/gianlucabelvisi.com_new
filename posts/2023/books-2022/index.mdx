...
And now that the component is written (click [here](https://github.com/gianlucabelvisi/gianlucabelvisi.com_new/blob/main/components/Books2022.tsx) for some code porn), I can reuse it on so many occasions. This blog will turn into spinning images so abruptly that you won't even remember that there was a static dark age.

The nineties are back!

<div style={{width:'100%', height:0, paddingBottom:'64%', position:'relative', marginBottom:'2rem'}}>
    <iframe src="https://giphy.com/embed/fJKG1UTK7k64w" width="100%" height="100%" style={{position:'absolute'}} frameBorder="0" className="giphy-embed" allowFullScreen/>
</div>
...
Well, according to my calculations, if no more books come out in 2023, we are almost there. Or at least I hope so. I don't want to spend another year like this.
...
In early December, I had to end a relationship 💔 so that I could find the time to read. There were also other problems.

I finally closed the circle on New Year's Eve, with midnight approaching like the guy from It Follows and while down with the flu, which meant that I had no time to make a bucket list. So that was nice!

![Header](books.jpg)

<FigureLabel>By the way, if you are of the <strong>stalker</strong> kind, you can follow my reading on <a href={"https://www.goodreads.com/user/show/12362887-gianluca-belvisi"}>Goodreads</a>, and you should thank me by <strong>not</strong> nailing a dead cat to my door</FigureLabel>
...
<div style={{width:'100%', height:0, paddingBottom:'75%', position:'relative', marginBottom:'2rem'}}>
    <iframe src="https://giphy.com/embed/gtakVlnStZUbe" width="100%" height="100%" style={{position:'absolute'}} frameBorder="0" className="giphy-embed" allowFullScreen/>
</div>
...
Speaking of, at the beginning of last year I was involved in some mad dating habits that sucked out all of my free time. Not to brag. While now my dating is way more normalized in its *lack-thereofness*. Again, not to brag. 🥲
...
The seminal work of From Software, notorious for making extremely difficult games whose stories require hours of [YouTube videos](https://www.youtube.com/@VaatiVidya) to make sense of them, was released last February, and is responsible for the loss of at least one percentage point in GDP.

With lore by George RR Martin, who would rather pen the menu of a family restaurant than finish The Winds of Winter, Elden Ring has stolen 130 hours of my life. Or should I say enriched? No, stolen.
...
The story takes place on the planet of Winter, where the inhabitants are human-like beings known as *Gethenians*, who are androgynous for most of the month and only become male or female during a brief fertile phase called kemmer.
...
After reading his autobiography *Surely You're Joking, Mr. Feynman!*, I found out that he was also a horny goofball. So there's hope for everyone!
...
At some point, I had reduced her health to a rounding error, with mine still topped up. This was it. This was the victory lap! And while I was removing my t-shirt to throw it to the crowds, she saw fit to execute her infamous waterfowl dance...

<YouTube source={"rlnv_DCBEa8"}/>
...
I'll recap for those who don't click on YouTube embeds.
...
This compelled me to rejoin the fight to save Neytiri, who sorely didn't need it. Be that as it may, it was me that landed the final blow from behind, AS SHE LIKES IT.
...
Now that I have closed the gap a bit, I can confidently announce that no one should ever read about this discipline, because philosophers are quite possibly the worst writers that ever walked the planet. It's like, bro, who hurt you? Why are you like this? Are you choosing the worst sentence structures, the longest streams of consciousness without a punctuation break, and the most obscure words to bemuse your readers enough that they will acquiesce in lying in the sack with you?

Don't we all.

![Plato](plato.jpg)

Unsurprisingly, the exceptions are those philosophers who are still alive. This is because they would not tolerate their writing to be ridiculed on the major social networks like Instagram, where Philosophy criticism is rampant.

The following are two examples.

## The Big Picture

In my objective opinion, Sean Carroll is the best Science and Philosophy communicator. He's just a pleasure to listen to. Of course, this is because Richard Feynman passed away in 1988. So I'm curious about Sean's whereabouts on February 15th of that year.
...
<FigureLabel>I also believe that <strong>Bill Nye</strong> and <strong>Neil deGrasse Tyson</strong> belong in prison.</FigureLabel>
...
<small>If you are one of those people who reply 42, I hate you so freaking much.</small><p></p>
...
Two years back, I tried reading Deutsch's *The Beginning of Infinity* and felt like my brain was too tiny. So, to properly understand it, I will have to write a series of blog posts about it, and as [Trello](/habits) shows, my backlog is filled. So we are looking at October.

In the meantime, I have read *The Fabric of Reality*, which is far more accessible.

In this work, Deutsch attempts to unify four theories:
1. Quantum theory
...
Every week or so, they publish a new strip on their website to keep engagement high. When they have collected enough material, they release it in a book that is in the price range to be the perfect gift that says "I like you, and I don't want to win you over with money."
...
But as already mentioned, at the beginning of last year I had the chance to handle some impressively big books, and I admit that I have changed my mind. I believe that there is a place for big books in this Society, and from now on I will be their staunch defender. Plus, we all know that what really matters is the cup!
...
<div style={{width:'100%', height:0, paddingBottom:'49%', position:'relative'}}>
    <iframe src="https://giphy.com/embed/l3q2zVr6cu95nF6O4" width="100%" height="100%" style={{position:'absolute'}} frameBorder="0" className="giphy-embed" allowFullScreen/>
</div><p></p>

What we can do well is act as filters: sift good ideas from the bad ones, merge them, season them with our backlog of experiences and, almost as a side effect, add a somewhat not too unoriginal spin.
...
This is, of course, derivative. It comes among others from René Girard who, being a dead philosopher, writes like shit. Consider not reading him.
...
(This is often attributed to the Talmud. I'm not that deep.)

### 3. It's hard

Please, remain engaged for a little longer. We are almost done.

We are rapidly moving toward a Society where any form of trivial thinking will have a market value of *nil*. Artificial Intelligence will handle all non-challenging thoughts, and automate away most of the [Bullshit Jobs](https://bookshop.org/search?keywords=Bullshit+Jobs+David+Graeber). Even solving crimes will be mainly delegated to sports cars.
...
Watching TikToks makes us worse by not making us better. This is not me throwing shade at the content creators, because those videos require craft and talent to make.

![Khaby Lame](kabhy.jpg)

<FigureLabel>Except for this guy</FigureLabel>

It's consuming them that is way too simple. It literally takes a finger!
...
As it turns out, we have all the tools for it. We are capable of so much more than what we are often resigned to doing. And since we can, we should.

Or not!

Alternatively, we could do none of it and keep watching reality shows with mildly famous people on an island starving themselves and pooping in the tall grass because sometimes we feel the need to shut our brains off.
...
And I want to stress that, while nothing expressed in this article is original, hopefully I managed to convey it in a configuration that made it engaging, and I did it by adding from my background in meme culture, video games, and juvenile humor.
...
After killing Malenia, I feel the urge to beat Elden Ring. After all, this is the other reason I ended a relationship 💔 a few months back.
...
<FigureLabel>The Elden Beast is squishy to the touch</FigureLabel>
...
No matter how many times this creature spreads me like nutella on sliced bread, I know that to succeed I just have to put in the hours, and I will not give up unt-- wait a second did he just die at the first attempt? 😲
