...
While I'm happy with the selection, I feel like this list is in aggregate **weaker** than the one from [2020](books-2020). So, if the trend continues, probably I won't have any interesting books to read by the year 2045, which I think is really cool because I want to spend time outside.
